...
import {NetworkRequest} from '../../node_modules/lighthouse/core/lib/network-request.js';
...
class CatAudit extends Audit {
  ...
  static calculateEcoIndexScore(domSize, requestCount, totalCompressedSize) {
    ...
    const ecoIndexScore = getEcoindex(domSize, requestCount, totalCompressedSize);
  ...
  static async audit(artifacts, context) {
    ...
    const ecoIndexScore = CatAudit.calculateEcoIndexScore(domSize, requestCount, totalCompressedSize);
