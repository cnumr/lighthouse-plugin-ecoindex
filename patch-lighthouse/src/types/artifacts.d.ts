...
export interface GathererArtifacts extends PublicGathererArtifacts {
  ...
  Inputs: {
    inputs: Artifacts.InputElement[]
    forms: Artifacts.FormElement[]
    labels: Artifacts.LabelElement[]
  }
  ...
  OptimizedImages: Array<
    Artifacts.OptimizedImage | Artifacts.OptimizedImageError
  >
  ...
  ServiceWorker: {
    versions: Crdp.ServiceWorker.ServiceWorkerVersion[]
    registrations: Crdp.ServiceWorker.ServiceWorkerRegistration[]
  }
...
declare module Artifacts {
  ...
  interface Script
    extends Omit<Crdp.Debugger.ScriptParsedEvent, 'url' | 'embedderName'> {
    /**
  ...
  type BFCacheNotRestoredReasonsTree = Record<
    Crdp.Page.BackForwardCacheNotRestoredReasonType,
    BFCacheReasonMap
  >
  ...
  interface FontSize {
    ...
    analyzedFailingNodesData: Array<{
      ...
      cssRule?: {
        ...
        parentRule?: {
          origin: Crdp.CSS.StyleSheetOrigin
