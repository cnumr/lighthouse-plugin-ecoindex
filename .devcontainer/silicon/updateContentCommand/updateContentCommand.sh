...
sudo sh /workspace/.devcontainer/silicon/updateContentCommand/install-chrome.sh
sudo sh /workspace/.devcontainer/silicon/updateContentCommand/install-git-lfs.sh