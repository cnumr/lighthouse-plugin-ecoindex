---
label: Mesure avec une authentification complexe [!badge NEW]
icon: unlock
order: 500
---
...
:::code source="../../custom-puppeteer-script-example/index.cjs" :::
===

==- Modèle de fichier de script Puppeteer custom (suite du fichier index.cjs)
:::code source="../../custom-puppeteer-script-example/puppeteer-helper.js" :::
===
...
:::code source="../../custom-puppeteer-script-example/.env.example" :::
===

[!button target="blank" icon="mark-github" text="Exemple de code complet"](https://github.com/cnumr/lighthouse-plugin-ecoindex/tree/main/custom-puppeteer-script-example)
