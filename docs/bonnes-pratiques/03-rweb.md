...
| `rweb-no-document-write`   | RWEB_0044 | Éviter les modifications DOM bloquantes                      |
| `rweb-no-unused-code`      | RWEB_0046 | Ne charger du code que lorsque c'est indispensable           |
