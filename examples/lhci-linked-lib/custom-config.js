...
const DOMInformations = import('lighthouse-plugin-ecoindex/gatherers/dom-informations.js')
/** @type {LH.Config} */
module.exports = {
  formFactor: 'desktop',
  ...
  artifacts: [
    {
      ...
      gatherer: '/workspace/lighthouse-plugin-ecoindex/gatherers/dom-informations.js'
    },
  ],
}