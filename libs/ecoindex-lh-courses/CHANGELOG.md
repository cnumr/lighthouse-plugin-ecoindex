...
- Updated dependencies [1b03763]
  - lighthouse-plugin-ecoindex-core@7.4.2

## 7.4.1

### Patch Changes

- Updated dependencies [93e371b]
  - lighthouse-plugin-ecoindex-core@7.4.1
...
- 9764d21: Improve browser installation log: add explicit message when browser is not installed instead of printing null.
...
- ba38609: Validation et ajout des flags Chrome dans la configuration Puppeteer :
