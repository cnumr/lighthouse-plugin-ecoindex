...
const UIStrings = {
  ...
  displayValue: 'Ecoindex nodes: {count}',
}
const str_ = createIcuMessageFn('audits/warn-nodes-count.js', UIStrings)
...
class WarnNodesCount extends Audit {
  ...
  static async audit(artifacts: LH.Artifacts) {
    ...
    return {
      ...
      displayValue: str_(UIStrings.displayValue, { count: value }),
      numericValue: value,
